...
<html lang="en">
    ...
    <body>
        ...
        <!-- intro line start -->
        <div class="container-fluid scene--fullwidth">
        ...
        <div class="container" id="intro_trigger">
            ...
            <div class="row scene scene__four" id="s4">
                ...
                <div class="col-12 scene__body">
                    <div class="row">
                        <div class="col-6 scene__graphic" id="s4_trigger">
                    ...
                    <div class="row scene__callout">
                        ...
                        <div class="col-4 flex-container scene__graphic">
                            <?php include('./images/svg/tree.php'); ?>
                        </div>
                    </div>

                    <div class="row scene__body">
                        <div class="col-md-1 arrow_icon flex-container"><img src="./images/temp_scene4_arrow.png" /></div>
                        <div class="col-md-8">Machine learning is essential for effective application performance monitoring.</div>
                    </div>
